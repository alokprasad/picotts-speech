/* Credit https://github.com/DougGore/picopi/blob/master/pico/tts/main.cpp */
#include <stdio.h>
#include <stdint.h>
#include <stdlib.h>
#include <string.h>
...
int main(int argc, char *argv[])
{
	...
	/*
	char Input[80] = "Hello World";	
	char* inputString = (char*) malloc (sizeof(char) * strlen(Input));
